      ...
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full space-y-11 px-4 lg:w-10/12">
            <!-- ==== warning alerts ==== -->
            <div
              class="flex w-full rounded-lg border-l-[6px] border-transparent bg-white px-7 py-8 shadow-1 dark:bg-dark-2 md:p-9"
            >
              <div
            ...
            <div
              class="flex w-full rounded-lg border-l-[6px] border-green bg-white px-7 py-8 shadow-1 dark:bg-dark-2 md:p-9"
            >
              <div
            ...
            <div class="inline-flex rounded-lg bg-red-light-6 px-[18px] py-4 shadow-[0px_2px_10px_0px_rgba(0,0,0,0.08)]" >
